...
exports.setPlayerID = (inID) => {
  return { type : exports.SET_PLAYER_ID,
    payload : { id : inID }
  };
};

exports.setPlayerName = (inName) => {
  return { type : exports.SET_PLAYER_NAME,
    payload : { name : inName }
  };
};
...
exports.gameData = (inGameData) => {
  return { type : exports.SET_GAME_DATA,
...
exports.answerButtonHighlight = (inButtonNumber) => {
  return { type : exports.ANSWER_BUTTON_HIGHLIGHT,
    payload : {
...
exports.updateAnswerButtonLabel = (inButtonNumber, inLabel) => {
  return { type : exports.UPDATE_ANSWER_BUTTON_LABEL,
    payload : {
      buttonNumber : inButtonNumber,
      label: inLabel,
    }
...
exports.resetAllButtons = () => {
  return { type : exports.RESET_ALL_BUTTONS,
    payload : { }
  };
};
...
exports.setQuestion = (inQuestion) => {
  return { type : exports.SET_QUESTION,
...
exports.setEndGameMessage = (inMessage) => {
  return { type : exports.SET_END_GAME_MESSAGE,
...
exports.updateLeaderboard = (inListData) => {
  return { type : exports.UPDATE_LEADERBOARD,
...
exports.setIsAdmin = (inIsAdmin) => {
  return { type : exports.SET_IS_ADMIN,
...
exports.setCurrentStatus = (inCurrentStatus) => {
  return { type : exports.SET_CURRENT_STATUS,
