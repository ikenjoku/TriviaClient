          ...
          <Card>
            ...
            <CardItem>
              <Body>
                ...
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                  <Text style={styles.fieldLabel}>Answered</Text> <Text>{this.props.answered}</Text>
                </View>
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                ...
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                  <Text style={styles.fieldLabel}>Right</Text> <Text>{this.props.right}</Text>
                </View>
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                ...
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                 <Text style={styles.fieldLabel}>Total Time</Text> <Text>{this.props.totalTime}</Text>
                </View>
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                ...
                <View style={[styles.fieldContainer, styles.fieldSpacing]}>
                 <Text style={styles.fieldLabel}>Fastest</Text> <Text>{this.props.fastest}</Text>
                </View>
                <View style={styles.fieldContainer}>
